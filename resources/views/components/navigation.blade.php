<div class="mx-auto max-w-7xl">
    <div x-data="{ showNavbar: true, lastScrollY: window.scrollY }" @scroll.window="
        ...
        <nav class="flex items-center justify-between px-4 max-w-7xl mx-auto">
            ...
            <div class="py-4 ">
                <a href="/">
                    <img class="md:w-[200px] w-[150px] " src="{{ asset('assets\imgs\face-py-logo.png') }}"
                        alt="FacePY ">
                </a>
            </div>
            ...
            <div class="hidden xl:flex">
                <ul class="flex items-center gap-10 ">
                    <li>
                        <x-nav-link href=""
                            :active="request()->routeIs('site.notre-processus')">
                            Notre Approche
                        </x-nav-link>
                    </li>
                    <li>
            ...
            <div class="flex xl:hidden">
                <button x-on:click="openMenu = !openMenu" aria-label="navMenu" :aria-expanded="openMenu"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none"
                        stroke="#58d185" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
    ...
    <ul class="absolute top-0 bottom-0 right-0 w-10/12 py-8 text-lg transition-all bg-white drop-shadow-2xl "
        ...
        <li class="py-10">
            <div class="flex justify-center ">
                <a href="/"><img class="h-[80px] md:h-[150px]" src="{{ asset('assets/images/Logo-Digiton-V.svg') }}"
                        alt=""></a>
            </div>
        </li>
