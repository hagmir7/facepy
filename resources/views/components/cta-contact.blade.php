<div id="contact-form-modal" x-data="{ modalOpen: false }" x-show="modalOpen"
    @open-contact-form-modal.window="modalOpen = true" class="fixed inset-0 z-50" aria-labelledby="modal-title"
    role="dialog" :aria-modal="modalOpen">
